...
// smidr::ui::fonts — load the bundled Inter Regular + Noto Sans Mono +
...
//     IMGUI_CHECKVERSION();
//     ImGui::CreateContext();
//     smidr::ui::ApplyDefaults();
//     smidr::ui::Fonts fonts = smidr::ui::LoadFonts(
//         ImGui::GetIO(),
...
//     ImGui::TextUnformatted(smidr::ui::icons::kCog " Settings");
