...
// smidr::ui::theme — the public entry points apps call once at host
// bring-up to skin every ImGui surface with the dark/flat/intentional
// palette from smidr::ui::tokens. Re-callable; safe after font-atlas
// rebuild or hot-reload.
//
// Typical host bring-up:
//
//     ImGui::CreateContext();
//     smidr::ui::ApplyDarkTheme(ImGui::GetStyle());
//     // optional, for multi-mode apps:
//     smidr::ui::ApplyAccent(ImGui::GetStyle(), smidr::ui::tokens::accents::violet);
//     // …backend init…
//
